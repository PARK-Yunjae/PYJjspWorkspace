	...
	<form action="${ctx}/memberAdd.do" method="post" enctype="multipart/form-data" >
		<table class="table table-bordered">
			<tr>
				<td>아이디</td>
				<td>
					<input class="col-5" type="text" name="id" id="id" autofocus />
			...
			<tr>
				<td>패스워드</td>
				<td>
					<input class="col-5" type="password" name="pass" id="pw"/>
				</td>
			</tr>
			<tr>
				<td>이름</td>
				<td>
					<input class="col-5" type="text" name="name" id="name"/>
				</td>
			</tr>
			<tr>
				<td>나이</td>
				<td>
					<input class="col-5" type="number" name="age" id="age"/>
				</td>
			</tr>
			<tr>
				<td>이메일</td>
				<td>
					<input class="col-5" type="email" name="email" id="email"/>
				</td>
			</tr>
			<tr>
				<td>전화번호</td>
				<td>
					<input class="col-5" type="tel" name="phone" id="phone"/>
				</td>
			</tr>
			<tr>
				<td>프로필 사진</td>
