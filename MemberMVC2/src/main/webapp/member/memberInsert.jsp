...
<form action="${ctx}/memberInsert.do">
	<table class="table table-bordered">
		...
		<tr>
			<td>나이</td>
			<td><input class="col-12" type="number" name="age" /></td>
		</tr>
		<tr>
			<td>이메일</td>
			<td><input class="col-12" type="email" name="email" /></td>
		</tr>
		<tr>
			<td>전화번호</td>
			<td><input class="col-12" type="tel" name="phone" /></td>
		</tr>
		<tr>
