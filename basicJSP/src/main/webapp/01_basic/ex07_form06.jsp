...
<body>
   ...
   <form action="ex08_form06pro.jsp" method="get">
   ...
   <a href="ex08_form06pro.jsp?num1=<%=10%>&num2=<%=20 %>"> form06pro로 이동 </a>
</body>
<script>
...
function goNextPage(){
	...
	let url = `ex08_form06pro.jsp?${name1}=${value1}&${name2}=${value2}`;
	goUrl(url);
}
